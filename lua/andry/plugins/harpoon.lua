...
vim.api.nvim_set_keymap('n', '<leader><leader>l', '<cmd>lua require("harpoon.ui").nav_file(3)<CR>', {noremap = true, silent = false})
vim.api.nvim_set_keymap('n', '<leader><leader>;', '<cmd>lua require("harpoon.ui").nav_file(4)<CR>', {noremap = true, silent = false})
